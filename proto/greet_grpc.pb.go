...
type GreetServiceClient interface {
	// simple RPC
	SayHelloMethod(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HelloResponse, error)
...
func (c *greetServiceClient) SayHelloMethod(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/greet_service.GreetService/SayHelloMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	// simple RPC
	SayHelloMethod(context.Context, *NoParam) (*HelloResponse, error)
	// server streaming RPC
...
func (UnimplementedGreetServiceServer) SayHelloMethod(context.Context, *NoParam) (*HelloResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayHelloMethod not implemented")
}
...
func _GreetService_SayHelloMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NoParam)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).SayHelloMethod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet_service.GreetService/SayHelloMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).SayHelloMethod(ctx, req.(*NoParam))
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SayHelloMethod",
			Handler:    _GreetService_SayHelloMethod_Handler,
		},
	},
